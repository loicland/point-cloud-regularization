...
public: 
    ...
    EnergyType totalData, totalSmooth;
	...
	EnergyType swap(int max_num_iterations=INT_MAX);//bool * neighbors,
...
private:
	...
	EnergyType oneSwapIteration();//bool* neighbors);
